  ...
  <section id="styles" class="s-styles">
	   ...
	   <div class="row add-bottom">
            ...
            <div class="col-twelve">
                ...
                <p>Validations par NiveauFormation et par Sexe</p>
...
$sexe=htmlspecialchars($_GET['q2']); $sexeL="";if($sexe=="G"){$sexeL="Garçons";}	if($sexe=="F"){$sexeL="Filles";}
	  ...
	  $requet=("SELECT * FROM  `codif_validation` where num_etu in(select num_etu from codif_etudiant where
	  niveauFormation='$niveauFormation' and sexe='$sexe')");
	  
	  $rqot=("SELECT nombre FROM  `codif_quota` where  niveauFormation='$niveauFormation' and sexe='$sexe'");
	  $eqot = mysqli_query($link, $rqot);$sqot= mysqli_fetch_array($eqot);$qota=$sqot['nombre'];
...
$ordre=0; 
echo "</b>Liste des etudiants ayant validé leur attribution: ".$niveauFormation." / ".$sexeL."</b>";
echo "<br></b>Rappel quota: ".$qota."</b>";
...
$r2 =("SELECT nom,prenoms FROM `codif_etudiant` where num_etu='$num_etu'");
$e2 = mysqli_query($link, $r2);$g2 = mysqli_fetch_array($e2);     

$nom=$g2['nom'];$prenoms=$g2['prenoms'];
