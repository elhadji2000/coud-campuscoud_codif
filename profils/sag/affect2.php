  ...
  <section id="styles" class="s-styles">
	   ...
	   <div class="row add-bottom">
            ...
            <div class="col-twelve">
                ...
                <p>Affectations par NiveauFormation et par Sexe</p>
...
$sexe=htmlspecialchars($_GET['q2']); $sexeL="";if($sexe=="G"){$sexeL="Garçons";}	if($sexe=="F"){$sexeL="Filles";}
	  ...
	  $requet=("SELECT * FROM  `codif_affectation` where num_etu in(select num_etu from codif_etudiant where
...
$ordre=0; 
echo "</b>Liste des etudiants attributaires de lits: ".$niveauFormation." / ".$sexeL."</b>";
